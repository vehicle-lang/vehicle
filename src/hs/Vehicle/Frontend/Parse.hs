{-# LANGUAGE LambdaCase #-}
{-# OPTIONS_GHC -fno-warn-missing-conv-synonym-signatures -fprint-potential-instances #-}
{-# LANGUAGE DataKinds #-}
...
--
-- We conv from the simple AST generated automatically by BNFC to our
...
-- and conv them into `Provenance` annotations.
