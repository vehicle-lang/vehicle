...
While Vehicle comes with several built-in differentiable logics, you can also define your own custom differentiable logic by implementing the `DifferentiableLogic` interface.
