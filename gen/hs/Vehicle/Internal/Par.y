...
%token
  ...
  '['                      { PT _ (TS _ 9)           }
  ']'                      { PT _ (TS _ 10)          }
  'declare-dataset'        { PT _ (TS _ 11)          }
  'declare-impl-parameter' { PT _ (TS _ 12)          }
  'declare-network'        { PT _ (TS _ 13)          }
  'declare-parameter'      { PT _ (TS _ 14)          }
  'declare-postulate'      { PT _ (TS _ 15)          }
  'define-fun'             { PT _ (TS _ 16)          }
  'lambda'                 { PT _ (TS _ 17)          }
  'let'                    { PT _ (TS _ 18)          }
  'pi'                     { PT _ (TS _ 19)          }
  '{'                      { PT _ (TS _ 20)          }
...
Binder
  : '(' NameToken ':' Expr ')' { Vehicle.Internal.Abs.RelevantExplicitBinder $2 $4 }
  | '{' NameToken ':' Expr '}' { Vehicle.Internal.Abs.RelevantImplicitBinder $2 $4 }
  | '{{' NameToken ':' Expr '}}' { Vehicle.Internal.Abs.RelevantInstanceBinder $2 $4 }
  | '.(' NameToken ':' Expr ')' { Vehicle.Internal.Abs.IrrelevantExplicitBinder $2 $4 }
  | '.{' NameToken ':' Expr '}' { Vehicle.Internal.Abs.IrrelevantImplicitBinder $2 $4 }
  | '.{{' NameToken ':' Expr '}}' { Vehicle.Internal.Abs.IrrelevantInstanceBinder $2 $4 }

Arg :: { Vehicle.Internal.Abs.Arg }
Arg
  : Expr1 { Vehicle.Internal.Abs.RelevantExplicitArg $1 }
  | '{' Expr '}' { Vehicle.Internal.Abs.RelevantImplicitArg $2 }
  | '{{' Expr '}}' { Vehicle.Internal.Abs.RelevantInstanceArg $2 }
  | '.(' Expr ')' { Vehicle.Internal.Abs.IrrelevantExplicitArg $2 }
  | '.{' Expr '}' { Vehicle.Internal.Abs.IrrelevantImplicitArg $2 }
  | '.{{' Expr '}}' { Vehicle.Internal.Abs.IrrelevantInstanceArg $2 }

Lit :: { Vehicle.Internal.Abs.Lit }
Lit
  : '()' { Vehicle.Internal.Abs.UnitLiteral }
  | Natural { Vehicle.Internal.Abs.NatLiteral $1 }
  | Rational { Vehicle.Internal.Abs.RatLiteral $1 }
  | BoolToken { Vehicle.Internal.Abs.BoolLiteral $1 }

Expr :: { Vehicle.Internal.Abs.Expr }
Expr
  : Expr1 ':' Expr1 { Vehicle.Internal.Abs.Ann $1 $3 }
...
Expr1
  ...
  | '[' ListExpr1 ']' { Vehicle.Internal.Abs.LVec $2 }
...
Decl
  ...
  | '(' 'declare-impl-parameter' NameToken Expr1 ')' { Vehicle.Internal.Abs.DeclImplParam $3 $4 }
  | '(' 'declare-postulate' NameToken Expr1 ')' { Vehicle.Internal.Abs.DeclPost $3 $4 }
