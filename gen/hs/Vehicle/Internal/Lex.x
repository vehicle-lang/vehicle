...
module Vehicle.Internal.Lex where
...
@rsyms = \( | \: | \) | \{ | \} | \{ \{ | \} \} | \. \( | \. \{ | \. \{ \{ | \( \) | \[ | \] | \, | "declare" \- "network" | "declare" \- "dataset" | "declare" \- "parameter" | "declare" \- "impl" \- "parameter" | "declare" \- "postulate" | "define" \- "fun"
...
-- token BuiltinToken
f o r a l l | e x i s t s | \= \> | a n d | o r | n o t | \= \= | \! \= | \< \= | \< | \> \= | \> | \* | \/ | \+ | \- | \~ | U n i t | N a t | I n t | I n d e x | B o o l | T e n s o r | L i s t | \: \: | \!
    { tok (eitherResIdent T_BuiltinToken) }

-- token NameToken
$s (\_ | ($d | $l)) *
    { tok (eitherResIdent T_NameToken) }

-- token BoolToken
T r u e | F a l s e
    { tok (eitherResIdent T_BoolToken) }
...
data Tok
  ...
  | T_BuiltinToken !Data.Text.Text
  | T_NameToken !Data.Text.Text
  | T_BoolToken !Data.Text.Text
...
tokenText t = case t of
  ...
  PT _ (T_BuiltinToken s) -> s
  PT _ (T_NameToken s) -> s
  PT _ (T_BoolToken s) -> s
...
resWords :: BTree
resWords =
  b "declare-impl-parameter" 12
    (b ".{" 6
       (b ")" 3 (b "()" 2 (b "(" 1 N N) N) (b ".(" 5 (b "," 4 N N) N))
       (b "[" 9
          (b ":" 8 (b ".{{" 7 N N) N)
          (b "declare-dataset" 11 (b "]" 10 N N) N)))
    (b "let" 18
       (b "declare-postulate" 15
          (b "declare-parameter" 14 (b "declare-network" 13 N N) N)
          (b "lambda" 17 (b "define-fun" 16 N N) N))
       (b "{{" 21
          (b "{" 20 (b "pi" 19 N N) N) (b "}}" 23 (b "}" 22 N N) N)))
  where
  b s n = B bs (TS bs n)
    where
    bs = Data.Text.pack s
