...
module Vehicle.Frontend.Lex where
...
-- token TokTCQuantify
I s Q u a n t i f y
    { tok (eitherResIdent T_TokTCQuantify) }

-- token TokTCNatural
I s N a t u r a l
    { tok (eitherResIdent T_TokTCNatural) }

-- token TokTCIntegral
I s I n t e g e r
    { tok (eitherResIdent T_TokTCIntegral) }

-- token TokTCRational
I s R a t i o n a l
    { tok (eitherResIdent T_TokTCRational) }

-- token TokTCReal
I s R e a l
    { tok (eitherResIdent T_TokTCReal) }
...
data Tok
  ...
  | T_TokTCQuantify !Data.Text.Text
  | T_TokTCNatural !Data.Text.Text
  | T_TokTCIntegral !Data.Text.Text
  | T_TokTCRational !Data.Text.Text
  | T_TokTCReal !Data.Text.Text
...
tokenText t = case t of
  ...
  PT _ (T_TokTCQuantify s) -> s
  PT _ (T_TokTCNatural s) -> s
  PT _ (T_TokTCIntegral s) -> s
  PT _ (T_TokTCRational s) -> s
  PT _ (T_TokTCReal s) -> s
  PT _ (T_Name s) -> s
...
resWords =
  b "inn" 9
    (b "=" 5
       ...
       (b "dataset" 7 (b "Type" 6 N N) (b "in" 8 N N)))
    (b "{" 13
       (b "network" 11 (b "let" 10 N N) (b "type" 12 N N))
