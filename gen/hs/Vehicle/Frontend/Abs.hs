...
-- | The abstract syntax of language Frontend.

module Vehicle.Frontend.Abs where
...
data Expr
    ...
    | Neg TokSub Expr
    | LSeq TokSeqOpen [Expr] TokSeqClose
    ...
    | TCEq TokTCEq Expr Expr
    | TCOrd TokTCOrd Expr Expr
    | TCCont TokTCContainer Expr Expr
    | TCTruth TokTCTruth Expr
    | TCQuant TokTCQuantify Expr
    | TCNat TokTCNatural Expr
    | TCInt TokTCIntegral Expr
    | TCRat TokTCRational Expr
    | TCReal TokTCReal Expr
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

data Decl
    = DeclNetw Name TokElemOf Expr
    | DeclData Name TokElemOf Expr
...
newtype TokReal = TokReal ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)
...
newtype TokProp = TokProp ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)
...
newtype TokTrue = TokTrue ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokFalse = TokFalse ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCEq = TokTCEq ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCOrd = TokTCOrd ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCContainer = TokTCContainer ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCTruth = TokTCTruth ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCQuantify = TokTCQuantify ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCNatural = TokTCNatural ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCIntegral = TokTCIntegral ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCRational = TokTCRational ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)

newtype TokTCReal = TokTCReal ((C.Int, C.Int), Data.Text.Text)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Data, C.Typeable, C.Generic)
...
instance HasPosition TokReal where
  hasPosition (TokReal (p, _)) = C.Just p
...
instance HasPosition TokProp where
  hasPosition (TokProp (p, _)) = C.Just p
...
instance HasPosition TokTrue where
  hasPosition (TokTrue (p, _)) = C.Just p

instance HasPosition TokFalse where
  hasPosition (TokFalse (p, _)) = C.Just p

instance HasPosition TokTCEq where
  hasPosition (TokTCEq (p, _)) = C.Just p

instance HasPosition TokTCOrd where
  hasPosition (TokTCOrd (p, _)) = C.Just p

instance HasPosition TokTCContainer where
  hasPosition (TokTCContainer (p, _)) = C.Just p

instance HasPosition TokTCTruth where
  hasPosition (TokTCTruth (p, _)) = C.Just p

instance HasPosition TokTCQuantify where
  hasPosition (TokTCQuantify (p, _)) = C.Just p

instance HasPosition TokTCNatural where
  hasPosition (TokTCNatural (p, _)) = C.Just p

instance HasPosition TokTCIntegral where
  hasPosition (TokTCIntegral (p, _)) = C.Just p

instance HasPosition TokTCRational where
  hasPosition (TokTCRational (p, _)) = C.Just p

instance HasPosition TokTCReal where
  hasPosition (TokTCReal (p, _)) = C.Just p
