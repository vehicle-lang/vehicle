...
module Vehicle.Frontend.Layout where
...
layoutWords = [( TokSymbol "let" 10
               , LayoutDelimiters (TokSymbol ";" 4) (Just (TokSymbol "{" 13)) (Just (TokSymbol "}" 15))
               )]

layoutStopWords :: [TokSymbol]
layoutStopWords = [TokSymbol "in" 8]
...
layoutSep   = List.nub $ TokSymbol ";" 4 : map (delimSep . snd) layoutWords
...
resolveLayout topLayout =
  ...
  topDelim = LayoutDelimiters (TokSymbol ";" 4) Nothing Nothing
