...
@rsyms = \( | \: "type" | \) | \{ | \} | \{ \{ | \} \} | \[ | \] | "declare" \- "network" | "declare" \- "dataset" | "define" \- "fun"
...
-- token BuiltinToken
f o r a l l | e x i s t s | \= \> | a n d | o r | n o t | \= \= | \! \= | \< \= | \< | \> \= | \> | \* | \/ | \+ | \- | \~ | N a t | I n t | R e a l | P r o p | B o o l | T e n s o r | L i s t | \: \: | \! | E q | O r d | C o n t a i n e r | T r u t h | Q u a n t i f y | N a t u r a l | I n t e g r a l | R a t i o n a l | R e a l
...
resWords =
  b "define-fun" 8
    (b "[" 4
       (b ")" 2 (b "(" 1 N N) (b ":type" 3 N N))
       (b "declare-dataset" 6 (b "]" 5 N N) (b "declare-network" 7 N N)))
    (b "{" 12
       (b "let" 10 (b "lambda" 9 N N) (b "pi" 11 N N))
