...
import Vehicle.Compile.Prelude (Name, Pretty (..), jsonOptions, developerError)
...
data MultiProperty property
  ...
  | -- | Multiple nested boolean properties e.g. generated by a `foreach`.
    ...
    -- originally: MultiProperty [MultiProperty property]
    StackMultiProperty [MultiProperty property]
  | AndMultiProperty (MultiProperty property) (MultiProperty property)
  | OrMultiProperty (MultiProperty property) (MultiProperty property)
...
multiPropertyAddresses :: MultiProperty PropertyAddress -> [PropertyAddress]
multiPropertyAddresses = \case
  SingleProperty address -> [address]
  StackMultiProperty ps -> concatMap multiPropertyAddresses ps
  AndMultiProperty {} -> developerError "function multiPropertyAddresses is currently unsupported for AndMuiltiProperty"
  OrMultiProperty {} -> developerError "function multiPropertyAddresses is currently unsupported for AndMuiltiProperty"
...
data SpecificationCacheIndex = SpecificationCacheIndex
  { resourcesIntegrityInfo :: ResourcesIntegrityInfo,
    properties :: [(PropertyName, MultiProperty PropertyAddress)]
  }
  deriving (Generic)
