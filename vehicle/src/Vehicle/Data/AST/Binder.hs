...
module Vehicle.Data.AST.Binder where
...
import Vehicle.Data.AST.Name (HasName (..), Name)
import Vehicle.Data.AST.Provenance (HasProvenance (..), Provenance, fillInProvenance)
import Vehicle.Data.AST.Relevance (HasRelevance (..), Relevance (..))
import Vehicle.Data.AST.Type
import Vehicle.Data.AST.Visibility (HasVisibility (..), Visibility (..), expandByArgVisibility)
