...
evalAtTensor ::
  forall builtin m.
  (MonadNormBuiltin m, HasTensorLiterals Value builtin, HasLiftableTensorOperations builtin, BuiltinHasListLiterals builtin, BuiltinHasIndexLiterals builtin, HasTensorExpr Value builtin, BuiltinHasForeach builtin, BuiltinHasTensors builtin) =>
  NamedBoundCtx ->
  EvalApp builtin m ->
  Eval builtin m ->
