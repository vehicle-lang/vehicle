...
-- | The JSON generated by Aeson does not list the keys of an object
--   in the order that corresponds to the fields of the record.
--   This list is meant to be passed as an argument to `prettyEncode'`.
orderOfLossFunctionKeys :: [Text]
orderOfLossFunctionKeys =
  [ "unary_operator_name",
    "unary_operator_arg",
    "binary_operator_name",
    "binary_operator_arg1",
    "binary_operator_arg2",
    "constant_value",
    "variable_name",
    "function_name",
    "function_args",
