...
elabExpr expr = case expr of
  ...
  B.Pow e1 tk e2 -> standardLibFunction "powTC" tk [e1, e2]
  B.Exp tk -> standardLibFunction "expTC" tk []
  B.Log tk -> standardLibFunction "logTC" tk []
  ...
  B.FromTimeToNat tk -> builtin (V.BuiltinCast (V.FromTime V.FromTimeToNat)) tk []
  B.StlGlobally tk -> builtinFunction (V.Temporal V.Globally) tk []
  B.StlFinally tk -> builtinFunction (V.Temporal V.Finally) tk []
  B.StlUntil tk -> builtinFunction (V.Temporal V.Until) tk []
  B.StlRollout tk -> builtinFunction V.Rollout tk []
  ...
  B.ExpRealTensor tk -> builtinFunction V.ExpRat tk []
  B.LogRealTensor tk -> builtinFunction V.LogRat tk []
  B.PowRealTensor tk -> builtinFunction V.PowRat tk []
