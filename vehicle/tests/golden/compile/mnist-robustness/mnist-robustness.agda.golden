...
RobustAround image label = ∀ (pertubation : Image) → let perturbedImage = sub image pertubation in BoundedByEpsilon pertubation × ValidImage perturbedImage → Advises perturbedImage label
