"""Loss-benchmark driver, records encoding of windController.

Runs N training iterations of a fixed 2->16->1 MLP against the records-style
windController spec. Wrapped by scripts/benchmark-loss.

The matching tensors-side driver is at ../windController/bench_train.py and
must stay in sync (same architecture, optimiser, seed, iteration count).
"""
