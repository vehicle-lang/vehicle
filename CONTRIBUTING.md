...
These wheels will have file names such as `vehicle_lang-0.4.1-cp311-cp311-macosx_13_0_arm64`:
...
#   versions      \
#                  vvvvvvvvvvv
vehicle_lang-0.4.1-cp311-cp311-macosx_13_0_arm64
#                              ^^^^^^^^^^^^^^^^^
#   Supported                /
...
8. **On a macOS machine with an M1/M2 chipset**
   ...
   ```
   vehicle_lang-0.4.1-cp310-cp310-macosx_13_0_arm64.whl
   vehicle_lang-0.4.1-cp37-cp37m-macosx_13_0_arm64.whl
   vehicle_lang-0.4.1-cp39-cp39-macosx_13_0_arm64.whl
   vehicle_lang-0.4.1-cp311-cp311-macosx_13_0_arm64.whl
   vehicle_lang-0.4.1-cp38-cp38-macosx_13_0_arm64.whl
   ```
