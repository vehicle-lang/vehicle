...
from vehicle_lang.interpret import compile
from vehicle_lang.interpret.builtin.python import PythonBuiltinInterpreter
from vehicle_lang.interpret.translation.python import PythonTranslation
...
def test_loss_function_exec(
    ...
    builtin_interpreter = PythonBuiltinInterpreter()
    translation = PythonTranslation(builtin_interpreter=builtin_interpreter)
